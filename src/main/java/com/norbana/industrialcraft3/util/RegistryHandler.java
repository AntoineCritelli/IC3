...
public class RegistryHandler {
    ...
    public static final RegistryObject<Block> RUBBER_SAPLING_BLOCK = BLOCKS.register("rubber_sapling_block", () -> new RubberSaplingBlock(() -> new RubberTree(), Block.Properties.from(Blocks.OAK_SAPLING)));
    public static final RegistryObject<Block> QUARRY_BLOCK = BLOCKS.register("quarry_block", () -> new QuarryBlock());
